...
class CFrmUserCode : public QDialog
{
    ...
    signals:
        ...
        void __OnDisplayTakeReturnButtons(bool showShowHide);
    ...
    public slots:
        ...
        void OnDisplayButtonsUpdate(bool dispFp, bool dispShowHide, bool dispTakeReturn);
