...
void CEncryption::calculatePredictiveCodeOld(uint32_t nLockNum, std::string skey, QDateTime datetime, std::string *poutEncrypt, uint32_t maxLength, QString *psTmp)
{
    uint32_t un32Sum = 0;
...
void CEncryption::calculatePredictiveCode(uint32_t nLockNum, std::string skey, QDateTime datetime, std::string *poutEncrypt, uint32_t maxLength, QString *psTmp)
{
    uint32_t un32Sum = 0;
    uint32_t unLockTmp = 0;
    uint32_t unEncSumDate = 0;
