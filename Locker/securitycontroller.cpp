...
void CSecurityController::initializeSignals()
{
    ...
    connect(&_modelSecurity, SIGNAL(__OnSecurityCheckSuccess(int,bool)), this, SLOT(OnSecurityCheckSuccess(int,bool)));
    ...
    connect(this, SIGNAL(__OnCreateHistoryRecordFromLastSuccessfulLogin(int,bool)), &_modelSecurity, SLOT(OnCreateHistoryRecordFromLastSuccessfulLogin(int,bool)));
    ...
    connect(&_modelSecurity, SIGNAL(__OnCreateHistoryRecordFromLastPredictiveLogin(int, QString, bool)), &_modelSecurity, SLOT(OnCreateHistoryRecordFromLastPredictiveLogin(int, QString, bool)));
...
qDebug() << sTmp;
	      ...
	      OnSecurityCheckSuccess(nLockNum,false);
                return;
            }
        }
    }
...
void CSecurityController::OnSecurityCheckSuccess(int doorNum, bool lockboxState)
{
    qDebug() << "CSecurityController::OnSecurityCheckSuccess(int nDoorNum)";
    emit __OnCreateHistoryRecordFromLastSuccessfulLogin(doorNum,lockboxState);
    emit __OnSecurityCheckSuccess(doorNum,lockboxState);
}
...
void CSecurityController::OnSecurityCheckSuccessWithAnswers(int doorNum, QString answer1, QString answer2, QString answer3)
{
  ...
  emit __OnSecurityCheckSuccess(doorNum,false);
