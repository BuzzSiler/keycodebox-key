  ...
  if(!_pfUsercode)
    {
      ...
      connect(psysController, SIGNAL(__OnCodeMessage(QString,bool)), _pfUsercode, SLOT(OnNewCodeMessage(QString,bool)));
      ...
      connect(_pfUsercode, SIGNAL(__OnLockerScreen()), psysController, SLOT(OnLockerScreen()));
