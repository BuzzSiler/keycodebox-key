...
signals:
    ...
    void __OnSecurityCheckSuccess(int doorNum, bool lockboxState);
    ...
    void __OnCreateHistoryRecordFromLastPredictiveLogin(int nLockNum, QString code, bool lockboxState);
signals:
...
private slots:
    ...
    void OnCreateHistoryRecordFromLastSuccessfulLogin(int doorNum, bool lockboxState);
    void OnCreateHistoryRecordFromLastSuccessfulLoginWithAnswers(QString answer1, QString answer2, QString answer3);
    void OnCreateHistoryRecordFromLastPredictiveLogin(int nLockNum, QString code, bool lockboxState);
